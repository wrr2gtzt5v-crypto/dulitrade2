...
═══════════════════════════════════
{
  ...
  "confidence_breakdown": {
    ...
    "vwap": 0=אין VWAP בגרף או מחיר רחוק / 1=מחיר קרוב ל-VWAP / 2=VWAP Reclaim או מחיר מעל עם תמיכה,
    "volume": 0=נפח נמוך מהממוצע / 1=נפח ממוצע / 2=נפח גבוה פי 1.5+ עם תנועה,
    "trend": 0=מגמה יורדת או אין מגמה / 1=מגמה ניטרלית / 2=מגמה ברורה לכיוון העסקה,
    "rr": 0=R/R מתחת 1.5 / 1=R/R 1.5-2.0 / 2=R/R מעל 2.0,
    "opening_range": 0=אין OR ברור או מחיר בתוך OR / 1=מחיר קרוב לOR / 2=פריצת OR ברורה עם נפח,
    "ema_ma": 0=מחיר מתחת EMA/MA / 1=מחיר על EMA/MA / 2=מחיר מעל EMA/MA עם תמיכה,
    "no_resistance": 0=התנגדות חזקה קרובה מאוד / 1=התנגדות בינונית / 2=אין התנגדות קרובה,
    "total": סכום כל השדות (0-16)
  },
